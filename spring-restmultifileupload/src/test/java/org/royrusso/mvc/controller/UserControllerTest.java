...
public class UserControllerTest {
    ...
    public void testUpload() throws Exception {
        ...
        String endpoint = "/user/uploadMultipleFiles";

        FileInputStream fis = new FileInputStream("D:\\sss.pdf");
        FileInputStream fis1 = new FileInputStream("D:\\sss1.pdf");
        ArrayList list=new ArrayList();
        MockMultipartFile multipartFile = new MockMultipartFile("file", fis);
        MockMultipartFile multipartFile1 = new MockMultipartFile("file1", fis1);
        list.add(multipartFile);
        mockMvc.perform(fileUpload(endpoint)
                .file(multipartFile).file(multipartFile1).param("name", "123.pdf,dhiva.pdf")
